...
修订结束后仍为 `failed` 的检索片段，正文保留并显示明确的“未获事实支持”标记，不生成角标。核心与非核心在这里一样处理，差别只体现在核验结论上，不体现在正文里。
...
正文因此不加整篇级别的标注（§3.9）。逐句的“未获事实支持”标记保留——那是具体的、可定位的，读者能据此判断哪一句不可信；而一句盖在整篇上的免责声明只会让人不再往下读，反而看不见那些具体标记。
